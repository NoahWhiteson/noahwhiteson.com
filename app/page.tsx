...
function InfoRow({
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 sm:px-6">
      <span className="flex w-36 shrink-0 items-center gap-2 font-mono text-xs text-muted-foreground">
...
function Tag({ children, dim }: { children: React.ReactNode; dim?: boolean }) {
  return (
    <span
      className={`rounded-md border border-edge px-2.5 py-1 font-mono text-xs ${
    ...
    <div className="mx-auto max-w-3xl overflow-x-clip border-x border-edge min-h-screen">
      ...
      <main>
        ...
        <section>
          ...
          <div className="px-4 pt-4 sm:px-6">
            <h1 className="flex items-center text-3xl font-semibold tracking-tight sm:text-4xl">
              ...
              <VerifiedIcon className="size-6 shrink-0 translate-y-0.5 sm:size-7" />
            </h1>
        ...
        <section>
          ...
          <div className="screen-line-before grid sm:grid-cols-3">
            {socials.map((social) => (
              <a
                key={social.label}
                href={social.href}
                ...
                className="flex items-center gap-3 border-b border-edge px-4 py-4 hover:bg-muted/50 sm:border-b-0 sm:border-r sm:last:border-r-0 sm:px-6"
              >
        ...
        <section id="experience">
          ...
          <div className="screen-line-before">
            {experience.map((exp) => (
              <div
                key={exp.org}
                className="border-b border-edge px-4 py-5 last:border-b-0 sm:px-6"
              >
                <div className="flex flex-wrap items-baseline justify-between gap-2">
                  <h3 className="flex items-center gap-2 text-base font-semibold">
                    <exp.icon className="size-4 shrink-0 text-muted-foreground" />
                    {exp.org}
                  </h3>
        ...
        <section>
          ...
          <div className="screen-line-before">
            {awards.map((award, i) => (
              <div
                key={i}
                className="flex flex-wrap items-baseline justify-between gap-2 border-b border-edge px-4 py-4 last:border-b-0 sm:px-6"
              >
                <div>
